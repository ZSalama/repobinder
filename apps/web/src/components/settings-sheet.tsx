...
export function SettingsSheet(props: {
  ...
  setRepositorySettingsDraft: Dispatch<
    SetStateAction<SettingsDraft | undefined>
  >;
  isBusy: boolean;
  isDesktop: boolean;
  onClose: () => void;
  ...
  const { repositorySettingsDraft, setRepositorySettingsDraft } = props;
      ...
      >
        <div className="sheetHeader">
          <div>
            ...
            <h2 id="repository-settings-title">Repository Settings</h2>
          </div>
          <button
        ...
        <form className="settingsForm" onSubmit={props.onSubmit}>
          <section
            ...
            aria-labelledby="repository-settings-section-title"
          >
                ...
                onChange={(event) =>
                  setRepositorySettingsDraft({
                    ...
                    autoStartDevServer: event.target.checked
                      ? repositorySettingsDraft.autoStartDevServer
                      : false,
                    tailscaleRouting: event.target.checked
                      ? repositorySettingsDraft.tailscaleRouting
                      : false,
                  })
                }
              />
            ...
            <label className="fieldStack">
              ...
              <textarea
                ...
                onChange={(event) =>
                  setRepositorySettingsDraft({
                    ...repositorySettingsDraft,
                    defaultArgsText: event.target.value,
                  })
                }
                placeholder="--install"
                disabled={!repositorySettingsDraft.setupEnabled}
            ...
            <label className="toggleRow">
              <input
                ...
                disabled={
                  !repositorySettingsDraft.setupEnabled ||
                  !repositorySettingsDraft.autoStartDevServer
                }
                onChange={(event) =>
                  setRepositorySettingsDraft({
